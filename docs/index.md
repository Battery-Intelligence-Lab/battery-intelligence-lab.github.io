...
We explore and optimise electrochemical energy storage devices, such as batteries and supercapacitors, in applications from electric cars to grid and off-grid power systems.
